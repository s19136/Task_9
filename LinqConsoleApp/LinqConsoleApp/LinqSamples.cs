    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task1()
        {
            ...
            var res = Emps.Where(t => t.Job == "Backend programmer");
            Console.WriteLine("\nTask 1");
            foreach (var el in res)
            {
                Console.WriteLine(el.Ename + " " + el.Job);
            }
        }
        ...
        public void Task2()
        {
            var res = Emps.Where(t => t.Job == "Backend programmer" & t.Salary > 1000).OrderByDescending(t => t.Ename);
            Console.WriteLine("\nTask 2");
            foreach (var el in res)
            {
                Console.WriteLine(el.Ename + " " + el.Job + " " +el.Salary);
            }
        ...
        public void Task3()
        {
            var res = Emps.Select(t => t.Salary).Max();
            Console.WriteLine("\nTask 3");
        ...
        public void Task4()
        {
            var res = Emps.Where(t => t.Salary == (Emps.Select(t => t.Salary).Max()));
            Console.WriteLine("\nTask 4");
            foreach (var el in res)
            {
                Console.WriteLine(el.Ename + " " + el.Job + " " + el.Salary);
        ...
        public void Task5()
        {
            var res = Emps.Select(emp => new { FirstName = emp.Ename, EmployeeJob = emp.Job });
            Console.WriteLine("\nTask 5");
            foreach (var el in res)
            {
                Console.WriteLine(el.FirstName + " " + el.EmployeeJob);
            }
        }
        ...
        public void Task6()
        {
            ...
            foreach (var el in res)
            {
                Console.WriteLine(el.Ename + " " + el.Job + " " + el.Dname);
            }
        }
        ...
        public void Task7()
        {
            var res = Emps.GroupBy(emp => emp.Job).Select(grp => new {
                EmployeeJob = grp.Key,
                EmployeeNumber = grp.Count()
            });;
            Console.WriteLine("\nTask 7");
            foreach (var el in res)
            {
                Console.WriteLine(el.EmployeeJob + " " + el.EmployeeNumber);
            }
        }
        ...
        public void Task8()
        {
            var res = Emps.Select(emp => emp.Job).Contains("Backend programmer");
            Console.WriteLine("\nTask 8");
            Console.WriteLine(res);
        }
        ...
        public void Task9()
        {
            ...
            Console.WriteLine("\nTask 9");
            Console.WriteLine(res.Ename + " " + res.Job + " " + res.HireDate);
        }
        ...
        public void Task10()
        {
            List<Emp> empty = new List<Emp>();
            empty.Add(new Emp { Ename = "No value", Job = null, HireDate = null });
            var res = Emps.Select(emp => new Emp { Ename = emp.Ename, Job = emp.Job, HireDate = emp.HireDate }).
                Union(empty);
            Console.WriteLine("\nTask 10");
            foreach (var el in res)
            {
                Console.WriteLine(el.Ename + " " + el.Job + " " + el.HireDate);
            }
        }
        ...
        public void Task11()
        {
            var res = Emps.Select(emp => emp).Aggregate((emp1, emp2) => emp1.Salary > emp2.Salary ? emp1 : emp2);
            Console.WriteLine("\nTask 11");
        ...
        public void Task12()
        {
            var res_1 = Emps.SelectMany(e => Depts, (x, y) => new {
                Ename = x.Ename,
                Dname = y.Dname
            });
            Console.WriteLine("\nTask 12");
